...
class SemiSupCon(nn.Module):
    
    def __init__(self, encoder, temperature = 0.1, pos_thresh = 1):
        super().__init__()
    ...
    def get_encoder_from_ckpt(self,ckpt_path):
...
class LightningSemiSupCon(SemiSupCon,pl.LightningModule):
    
    def __init__(self, encoder, 
        optimizer: OptimizerCallable = None, temperature = 0.1, pos_thresh = 1):
        super().__init__(encoder,temperature,pos_thresh)
